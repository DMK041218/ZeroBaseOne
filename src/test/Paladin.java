...
public class Paladin extends Archetypes {
    ...
    public Paladin(String name, String playerName, int healthPoints, int manaPoints, int physicalDefense,
            int magicalDefense,
    ...
    public Paladin(String name, String playerName, int healthPoints, int manaPoints, int level, int xp,
