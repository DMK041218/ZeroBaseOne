        ...
        do {
            ...
            try {
                ...
                System.out.println(ColorText.colorText(
                        "Please Enter a Number Within the Given Range as Choice and Nothing Else.", ColorText.RED));
            }
        ...
        do {
            ...
            try {
                ...
                System.out.println(ColorText
                        .colorText("Please Enter Your Choice Within the Given Range and Nothing Else.", ColorText.RED));
            }
        } while (!rightChoice);
        return input;
    }
    ...
    public Archetypes printBeginningMenu() {
        ...
        switch (readChoice("-->", 3)) {
            ...
            case 2:
                ...
                loadGame.loadGameFirst();
                if (loadGame.getName().equals("Warrior")) {
                    return loadGame.load1();
                } else if (loadGame.getName().equals("Mage")) {
                    return loadGame.load2();
                } else if (loadGame.getName().equals("Archer")) {
                    return loadGame.load3();
                } else if (loadGame.getName().equals("Paladin")) {
                    return loadGame.load4();
                } else if (loadGame.getName().equals("Rogue")) {
                    return loadGame.load5();
                } else
                    return null;
